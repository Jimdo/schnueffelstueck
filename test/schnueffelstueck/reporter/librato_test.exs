defmodule Schnueffelstueck.Reporter.LibratoTest do
  ...
  test "build the json request body in the librato format" do
    ...
    assert body == ~s({"gauges":[{"measure_time":1457364121,"name":"servicename.fastly.cache_hit.HIT","source":"cache-lhr6325","value":1}]})
  end
  ...
  test "transform the keeps the order of metrics" do
    ...
    assert body == [
      %{"measure_time" => 1457364121, "name" => "servicename.fastly.cache_hit.HIT", "source" => "cache-lhr6325", "value" => 1},
      %{"measure_time" => 1457364121, "name" => "servicename.fastly.status.200", "source" => "cache-ams6525", "value" => 1}
    ]
  end
  ...
  test "transform adds metrics to the beginning of the existing list" do
    ...
    body = Librato.transform(metrics, "servicename", [
      %{"measure_time" => 1457364121, "name" => "servicename.fastly.request", "source" => "cache-fra6375", "value" => 1}
    ])
    assert body == [
      %{"measure_time" => 1457364121, "name" => "servicename.fastly.request", "source" => "cache-fra6375", "value" => 1},
      %{"measure_time" => 1457364121, "name" => "servicename.fastly.cache_hit.HIT", "source" => "cache-lhr6325", "value" => 1},
  ...
  test "transform the `request` metric" do
    ...
    assert Librato.transform([metric], "servicename", []) == [
      %{"measure_time" => 1457364121, "name" => "servicename.fastly.requests", "source" => "cache-lhr6325", "value" => 1}
    ]
  end
  ...
  test "transform the `status` metric" do
    ...
    assert Librato.transform([metric], "servicename", []) == [
      %{"measure_time" => 1457364121, "name" => "servicename.fastly.status.200", "source" => "cache-lhr6325", "value" => 1}
    ]
  end
  ...
  test "transform the `method` metric" do
    ...
    assert Librato.transform([metric], "servicename", []) == [
      %{"measure_time" => 1457364121, "name" => "servicename.fastly.method.GET", "source" => "cache-lhr6325", "value" => 1}
    ]
  end
  ...
  test "transform the `bytes` metric" do
    ...
    assert Librato.transform([metric], "servicename", []) == [
      %{"measure_time" => 1457364121, "name" => "servicename.fastly.bytes", "source" => "cache-lhr6325", "value" => 73080}
    ]
  end
  ...
  test "transform the `latency` metric" do
    ...
    assert Librato.transform([metric], "servicename", []) == [
      %{"measure_time" => 1457364121, "name" => "servicename.fastly.origin_latency", "source" => "cache-lhr6325", "value" => 0}
    ]
  end
end
